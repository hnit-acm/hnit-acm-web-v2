  ...
  <div v-for="(item, index) in data" :key="index">
    <el-card class="box-card" shadow="hover">
      <div style="margin: -10px -10px -26px;display: flex; flex-direction: row; width: 100%">
        <img class="hidden-xs-only" :src="item.avatar" alt="contest picture"
        ...
        <div style="display: flex;width: 100%; flex-direction: column">
          <div style="display: flex; flex-direction: row">
            ...
            <el-tag type="danger" style="margin-top: auto;margin-bottom: auto; margin-left: 10px" size="small">进行中
            </el-tag>
          </div>
          <div style="display: flex;width: 100%; flex-direction: row">
            <p style="text-align: start; margin-right: 10px" class="p_line_hidden">{{ item.description }}</p>
          ...
          <el-row>
            ...
            <el-col :md="5" :sm="9" :xs="12">
              <p style="white-space: nowrap; font-size: 0.9em;width: 100%; text-align: center">竞赛时间：{{
                  item.startTime
                }}</p>
            </el-col>
            ...
            <el-col :md="5" :sm="9" :xs="12">
              <p style="white-space: nowrap; font-size: 0.9em;width: 100%; text-align: center">报名截止时间：{{
                  item.endTime
                }}</p>
            </el-col>
            <el-col :md="5" :sm="2" :xs="0"/>
